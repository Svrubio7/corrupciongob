<template>
  <div class="my-6 bg-white rounded-xl shadow-md hover:shadow-lg transition overflow-hidden border border-gray-100">
    <!-- Sponsor badges -->
    <div class="flex gap-2 px-4 pt-2 pb-2 justify-center">
      <span class="inline-block bg-yellow-100 text-yellow-800 text-xs font-bold px-2 py-1 rounded-full">¡Sponsor Oficial!</span>
      <span class="inline-block bg-blue-100 text-blue-800 text-xs font-bold px-2 py-1 rounded-full">Anuncio</span>
    </div>
    
    <!-- Main content -->
    <div class="flex flex-col md:flex-row p-4 gap-4">
      <!-- Image -->
      <div class="flex-shrink-0 w-full md:w-60 h-28 md:h-32">
        <img
      ...
      <div class="flex-1 flex flex-col justify-between">
        ...
        <div class="flex flex-col sm:flex-row justify-center md:justify-start gap-3">
          <a
            ...
            class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold text-sm transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 border-2 border-blue-600 hover:border-blue-700 text-center"
          >
            Saber más
          </a>
          <a
